 ...
 * References:
 *  - [Error Response]
 *        (http://tools.ietf.org/html/draft-ietf-oauth-v2-28#section-5.2)
 *  - [Authorization Response]
 *        (http://tools.ietf.org/html/draft-ietf-oauth-v2-28#section-4.1.2)
 *  - [Authorization Response]
  ...
  return function errorHandler(err, req, res, next) {
    if (mode === 'direct') {
      ...
      if (enc === 'fragment') {
        ...
        if (req.oauth2.req && req.oauth2.req.state) {
          hash.state = req.oauth2.req.state;
        }
        ...
        if (req.oauth2.req && req.oauth2.req.state) {
          uri.query.state = req.oauth2.req.state;
        }
      }
